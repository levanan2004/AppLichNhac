...
class _AddCustomerScreenState extends State<AddCustomerScreen> {
  ...
  void _generateAutoReminders(DateTime baseDate) {
    setState(() {
      _reminders = [
        ReminderInput(
          description: 'Nhắc nhở sau 3 ngày - Gọi hỏi về cảm nhận',
          date: baseDate.add(const Duration(days: 3)),
        ),
        ReminderInput(
          description: 'Nhắc nhở sau 1 tuần - Hỏi thăm cảm nhận',
          date: baseDate.add(const Duration(days: 7)),
        ),
        ReminderInput(
          description: 'Nhắc nhở sau 15 ngày - Tư vấn sản phẩm mới',
          date: baseDate.add(const Duration(days: 15)),
        ),
        ReminderInput(
          description: 'Nhắc nhở sau 1 tháng - Đánh giá hiệu quả tổng thể',
          date: DateTime(baseDate.year, baseDate.month + 1, baseDate.day),
        ),
        ReminderInput(
          description: 'Nhắc nhở sau 3 tháng - Tái sử dụng dịch vụ',
          date: DateTime(baseDate.year, baseDate.month + 3, baseDate.day),
        ),
        ReminderInput(
          description: 'Nhắc nhở sau 6 tháng - Chăm sóc định kỳ',
